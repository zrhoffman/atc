...
class TomcatLifecycleListener : LifecycleListener {
    ...
    override fun lifecycleEvent(event: LifecycleEvent?) {
        ...
        try {
            ...
            throw RuntimeException("Failed to register MBean " + DeliveryServiceCertificatesMBean.Companion.OBJECT_NAME + " " + e.javaClass.simpleName + ": " + e.message, e)
        }
    }
    ...
    companion object {
        private val log = LogManager.getLogger(LifecycleListener::class.java)
    }
}