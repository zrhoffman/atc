...
class HttpsProperties {
    private val httpsPropertiesMap: MutableMap<String?, String?>? = loadHttpsProperties()
    ...
    companion object {
        ...
        private fun loadHttpsProperties(): MutableMap<String?, String?>? {
            return try {
                ...
                Files.readAllLines(Paths.get(HTTPS_PROPERTIES_FILE)).forEach(Consumer { propString: String ->
