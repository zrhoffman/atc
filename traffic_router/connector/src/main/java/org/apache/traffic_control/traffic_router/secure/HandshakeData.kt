...
class HandshakeData(private val deliveryService: String?, private val hostname: String?, private val certificateChain: Array<X509Certificate?>?, private var privateKey: PrivateKey?) {
    ...
    override fun equals(o: Any?): Boolean {
        ...
        return deliveryService == that.deliveryService && hostname == that.hostname &&
                Arrays.equals(certificateChain, that.certificateChain) && privateKey == that.privateKey
    }
