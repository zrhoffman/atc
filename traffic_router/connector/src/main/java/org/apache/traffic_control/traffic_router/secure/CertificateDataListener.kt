    ...
    override fun handleNotification(notification: Notification?, handback: Any?) {
        ...
        if (certificateDataList.javaClass.isInstance(newValue)) {
            ...
            try {
                ...
                CertificateDataListener.Companion.log.warn("Failed importing certificate data list into registry " + t.javaClass.simpleName, t)
            }
        }
    }

    companion object {
        private val log = LogManager.getLogger(CertificateDataListener::class.java)
    }
}