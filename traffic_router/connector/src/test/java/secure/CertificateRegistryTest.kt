...
class CertificateRegistryTest constructor() {
    ...
    fun itRetrysCertificateDataOnEndpointFail() {
        val handshakeData3mod: HandshakeData? = Mockito.mock(HandshakeData::class.java)
        Mockito.`when`(handshakeData3mod.getHostname()).thenReturn("*.ds-3.some-cdn.example.com")
        val certificateData3mod: CertificateData? = Mockito.mock(CertificateData::class.java)
        ...
        val endpoint: RouterNioEndpoint? = Mockito.mock(RouterNioEndpoint::class.java)
