...
import org.apache.traffic_control.traffic_router.shared.*
...
class CertificateDataConverterTest {
    ...
    fun before() {
        ...
        certificate.crt = "encodedchaindata"
        certificate.key = "encodedkeydata"
    ...
    fun itConvertsValidCertToHandshakeData() {
        try {
            certificateData = ObjectMapper().readValue<CertificateData?>(CertificateDataConverterTest.Companion.VALID_CERT_DATA,
        ...
        MatcherAssert.assertThat(handshakeData.deliveryService, Matchers.equalTo(certificateData.getDeliveryservice()))
        MatcherAssert.assertThat(handshakeData.hostname, Matchers.equalTo(certificateData.getHostname()))
    }
    ...
    fun itRejectsExpiredCert() {
        try {
            certificateData = ObjectMapper().readValue<CertificateData?>(CertificateDataConverterTest.Companion.EXPIRED_CERT_DATA,
                    object : TypeReference<CertificateData?>() {}) as CertificateData?
        } catch (e: Exception) {
            Assert.fail("Failed parsing json data: " + e.message)
        }
    ...
    fun itRejectsModulusMismatch() {
        try {
            certificateData = ObjectMapper().readValue<CertificateData?>(CertificateDataConverterTest.Companion.MOD_MISS_CERT_DATA,
                    object : TypeReference<CertificateData?>() {}) as CertificateData?
        } catch (e: Exception) {
            Assert.fail("Failed parsing json data: " + e.message)
        }
    ...
    fun itRejectsSubjectMismatch() {
        try {
            certificateData = ObjectMapper().readValue<CertificateData?>(CertificateDataConverterTest.Companion.SUBJECT_MISS_CERT_DATA,
                    object : TypeReference<CertificateData?>() {}) as CertificateData?
        } catch (e: Exception) {
            Assert.fail("Failed parsing json data: " + e.message)
        }
    ...
    fun itAcceptsSubjectAlternateNames() {
        try {
            certificateData = ObjectMapper().readValue<CertificateData?>(CertificateDataConverterTest.Companion.VALID_SAN_CERT_DATA,
                    object : TypeReference<CertificateData?>() {}) as CertificateData?
        } catch (e: Exception) {
            Assert.fail("Failed parsing json data: " + e.message)
        }
    ...
    fun itAcceptsWildcardSubjectAlternateNames() {
        try {
            certificateData = ObjectMapper().readValue<CertificateData?>(CertificateDataConverterTest.Companion.VALID_SAN_WILDCARD_CERT_DATA,
                    object : TypeReference<CertificateData?>() {}) as CertificateData?
        } catch (e: Exception) {
            Assert.fail("Failed parsing json data: " + e.message)
        }
    ...
    companion object {
      ...
      "certificate": {
        ...
        "key": "",
        "crt": ""
      },
      "hostname": "*.https-valid-test.thecdn.example.com"
    }"""
      ...
      "certificate": {
        ...
        "key": "",
        "crt": ""
      },
