...
class CertificateDataConverterTest {
    ...
    fun itConvertsValidCertToHandshakeData() {
        try {
            certificateData = ObjectMapper().readValue<Any?>(CertificateDataConverterTest.Companion.VALID_CERT_DATA,
    ...
    fun itRejectsExpiredCert() {
        try {
            certificateData = ObjectMapper().readValue<Any?>(CertificateDataConverterTest.Companion.EXPIRED_CERT_DATA,
                object : TypeReference<CertificateData?>() {}) as CertificateData?
        } catch (e: Exception) {
            Assert.fail("Failed parsing json data: " + e.message)
        }
    ...
    fun itRejectsModulusMismatch() {
        try {
            certificateData = ObjectMapper().readValue<Any?>(CertificateDataConverterTest.Companion.MOD_MISS_CERT_DATA,
                object : TypeReference<CertificateData?>() {}) as CertificateData?
        } catch (e: Exception) {
            Assert.fail("Failed parsing json data: " + e.message)
        }
    ...
    fun itRejectsSubjectMismatch() {
        try {
            certificateData =
                ObjectMapper().readValue<Any?>(CertificateDataConverterTest.Companion.SUBJECT_MISS_CERT_DATA,
                    object : TypeReference<CertificateData?>() {}) as CertificateData?
        } catch (e: Exception) {
            Assert.fail("Failed parsing json data: " + e.message)
        }
    ...
    fun itAcceptsSubjectAlternateNames() {
        try {
            certificateData = ObjectMapper().readValue<Any?>(CertificateDataConverterTest.Companion.VALID_SAN_CERT_DATA,
                object : TypeReference<CertificateData?>() {}) as CertificateData?
        } catch (e: Exception) {
            Assert.fail("Failed parsing json data: " + e.message)
        }
    ...
    fun itAcceptsWildcardSubjectAlternateNames() {
        try {
            certificateData =
                ObjectMapper().readValue<Any?>(CertificateDataConverterTest.Companion.VALID_SAN_WILDCARD_CERT_DATA,
                    object : TypeReference<CertificateData?>() {}) as CertificateData?
        } catch (e: Exception) {
            Assert.fail("Failed parsing json data: " + e.message)
        }
