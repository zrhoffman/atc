...
class RouterSslImplementationTest constructor() {
    var sslSession: SSLSession? = PowerMockito.mock(SSLSession::class.java)
    var sslHostConfig: SSLHostConfig? = PowerMockito.mock(SSLHostConfig::class.java)
    var type: SSLHostConfigCertificate.Type? = PowerMockito.mock(
    ...
    var sslutil: RouterSslUtil? = PowerMockito.mock(RouterSslUtil::class.java)
    @Test
