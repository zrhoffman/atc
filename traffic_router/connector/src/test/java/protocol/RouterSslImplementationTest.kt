...
class RouterSslImplementationTest {
    ...
    var type = PowerMockito.mock(SSLHostConfigCertificate.Type::class.java)
    ...
    fun itReturnsSSLSupport() {
        MatcherAssert.assertThat(RouterSslImplementation().getSSLSupport(sslSession), Matchers.instanceOf(SSLSupport::class.java))
    }
    ...
    fun itReturnsSSLUtil() {
        ...
        MatcherAssert.assertThat(RouterSslImplementation().getSSLUtil(sslHostConfigCertificate), Matchers.instanceOf(SSLUtil::class.java))
    }
