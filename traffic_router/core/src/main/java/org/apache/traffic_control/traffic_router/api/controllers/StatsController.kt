...
import org.apache.traffic_control.traffic_router.core.util.DataExporterimport

import org.springframework.beans.factory.annotation .Autowiredimport org.springframework.stereotype.Controllerimport org.springframework.web.bind.annotation .GetMappingimport org.springframework.web.bind.annotation .PathVariableimport org.springframework.web.bind.annotation .RequestParamimport org.springframework.web.bind.annotation .ResponseBody org.springframework.web.bind.annotation .RequestMapping
...
class StatsController {
    ...
    @ResponseBody
    fun getCaches(@PathVariable("ip") ip: String?,
                  @RequestParam(name = "geolocationProvider", required = false, defaultValue = "maxmindGeolocationService") geolocationProvider: String?): MutableMap<String?, Any?>? {
