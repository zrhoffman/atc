...
org.apache.logging.log4j.LogManagerimport org.apache.traffic_control.traffic_router.core.config.CertificateCheckerimport org.apache.traffic_control.traffic_router.shared.CertificateData org.springframework.web.bind.annotation .RequestMapping
...
class CertificateChecker {
    ...
    fun certificatesAreValid(certificateDataList: MutableList<CertificateData?>?, deliveryServicesJson: JsonNode?): Boolean {
    ...
    private fun deliveryServiceHasValidCertificates(certificateDataList: MutableList<CertificateData?>?, deliveryServicesJson: JsonNode?, deliveryServiceId: String?): Boolean {
    ...
    companion object {
        private val LOGGER = LogManager.getLogger(CertificateChecker::class.java)
    }
}