 ...
 */
package org.apache.traffic_control.traffic_router.core.routerimportimportimport

com.fasterxml.jackson.databind.JsonNodeimport org.apache.traffic_control.traffic_router.core.dns.NameServerimport org.apache.traffic_control.traffic_router.core.ds.SteeringRegistryimport org.apache.traffic_control.traffic_router.core.edge.CacheRegisterimport org.apache.traffic_control.traffic_router.core.loc.AnonymousIpDatabaseServiceimport org.apache.traffic_control.traffic_router.core.loc.FederationRegistryimport org.apache.traffic_control.traffic_router.core.router.StatTrackerimport org.apache.traffic_control.traffic_router.core.router.TrafficRouterimport org.apache.traffic_control.traffic_router.core.router.TrafficRouterManagerimport org.apache.traffic_control.traffic_router.core.util.TrafficOpsUtilsimport org.apache.traffic_control.traffic_router.geolocation.GeolocationServiceimport org.springframework.context.ApplicationListenerimport org.springframework.context.event.ContextRefreshedEventimport java.io.IOExceptionimport java.util.concurrent.ConcurrentHashMap org.apache.logging.log4j.LogManager
import org.springframework.context.ApplicationContextimport

java.net.* org.springframework.web.bind.annotation .RequestMapping
...
class TrafficRouterManager : ApplicationListener<ContextRefreshedEvent?> {
    ...
    fun setCacheRegister(cacheRegister: CacheRegister?) {
        ...
        val tr = TrafficRouter(cacheRegister, geolocationService, geolocationService6, anonymousIpService, statTracker, trafficOpsUtils, federationRegistry, this)
    ...
    companion object {
        private val LOGGER = LogManager.getLogger(TrafficRouterManager::class.java)
