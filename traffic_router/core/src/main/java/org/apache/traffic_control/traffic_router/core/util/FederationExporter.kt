...
import org.apache.traffic_control.traffic_router.core.loc.FederationMappingimport

import org.apache.traffic_control.traffic_router.core.loc.FederationRegistryimport org.apache.traffic_control.traffic_router.core.util.CidrAddressimport org.apache.traffic_control.traffic_router.core.util.ComparableTreeSet org.springframework.web.bind.annotation .RequestMapping
...
class FederationExporter {
    ...
    private fun getMappingProperties(cidrAddress: CidrAddress?, federationMapping: FederationMapping?): MutableMap<String?, Any?>? {
    ...
    private fun addAddressProperties(propertyName: String?, cidrAddresses: ComparableTreeSet<CidrAddress?>?, properties: MutableMap<String?, Any?>?): MutableMap<String?, Any?>? {
