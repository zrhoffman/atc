...
org.apache.traffic_control.traffic_router.core.router.TrafficRouterManagerimport org.springframework.beans.factory.annotation .Autowiredimport org.springframework.http.HttpStatusimport org.springframework.http.ResponseEntityimport org.springframework.stereotype.Controllerimport org.springframework.web.bind.annotation .RequestParamimport org.springframework.web.bind.annotation .ResponseBodyimport java.net.*import javax.servlet.http.HttpServletRequest
...
class DeliveryServicesController {
    ...
    @RequestMapping
    @ResponseBody
    fun getDeliveryService(request: HttpServletRequest?, @RequestParam(name = "url") url: String?): ResponseEntity<MutableMap<String?, String?>?>? {
        val decodedUrl: URL
        decodedUrl = try {
