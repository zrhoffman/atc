...
import org.apache.traffic_control.traffic_router.core.ds.DeliveryServiceimport

org.apache.traffic_control.traffic_router.core.router.RouteResultimport java.net.*import java.util.*
...
class HTTPRouteResult(private val multiRouteRequest: Boolean) : RouteResult {
    ...
    fun getDeliveryServicesLogString(): String? {
        return getDeliveryServices().stream().map { obj: DeliveryService? -> obj.getId() }.collect(Collectors.joining("|"))
    }
