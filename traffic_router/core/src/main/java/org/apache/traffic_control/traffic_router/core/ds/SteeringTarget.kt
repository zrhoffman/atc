 ...
 */
package org.apache.traffic_control.traffic_router.core.dsimportimport

com.fasterxml.jackson.annotation .JsonPropertyimport org.apache.traffic_control.traffic_router.core.ds.SteeringTargetimport org.apache.traffic_control.traffic_router.core.hash.DefaultHashableimport org.apache.traffic_control.traffic_router.geolocation.Geolocation org.springframework.web.bind.annotation .RequestMapping
...
class SteeringTarget : DefaultHashable() {
    ...
    @JsonProperty
    private var latitude: Double = SteeringTarget.Companion.DEFAULT_LAT

    @JsonProperty
    private var longitude: Double = SteeringTarget.Companion.DEFAULT_LON
    ...
    fun getGeolocation(): Geolocation? {
        ...
        if (latitude != SteeringTarget.Companion.DEFAULT_LAT && longitude != SteeringTarget.Companion.DEFAULT_LON) {
    ...
    override fun equals(o: Any?): Boolean {
        ...
        return if (weight != target.weight || order != target.order || geoOrder != target.geoOrder || latitude != target.latitude || longitude != target.longitude) false else deliveryService == target.deliveryService
    }
