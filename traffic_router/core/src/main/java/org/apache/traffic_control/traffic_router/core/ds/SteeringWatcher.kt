 ...
 */
package org.apache.traffic_control.traffic_router.core.dsimportimportimport

org.apache.traffic_control.traffic_router.core.ds.SteeringRegistryimport org.apache.traffic_control.traffic_router.core.ds.SteeringWatcherimport org.apache.traffic_control.traffic_router.core.util.AbstractResourceWatcherimport org.apache.traffic_control.traffic_router.core.util.TrafficOpsUtils org.apache.logging.log4j.LogManager
...
class SteeringWatcher : AbstractResourceWatcher() {
    ...
    companion object {
        private val LOGGER = LogManager.getLogger(SteeringWatcher::class.java)
        val DEFAULT_STEERING_DATA_URL: String? = "https://\${toHostname}/api/" + TrafficOpsUtils.Companion.TO_API_VERSION + "/steering"
    }
}