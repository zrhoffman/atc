...
import org.apache.traffic_control.traffic_router.core.loc.FederationMappingimport org.apache.traffic_control.traffic_router.core.util.CidrAddressimport org.apache.traffic_control.traffic_router.core.util.ComparableTreeSet org.springframework.web.bind.annotation .RequestMapping
...
class FederationMapping(private val cname: String?, private val ttl: Int, resolve4: ComparableTreeSet<CidrAddress?>?, resolve6: ComparableTreeSet<CidrAddress?>?) : Comparable<FederationMapping?> {
    ...
    protected fun getResolveMatches(resolves: MutableSet<CidrAddress?>?, cidrAddress: CidrAddress?): ComparableTreeSet<CidrAddress?>? {
