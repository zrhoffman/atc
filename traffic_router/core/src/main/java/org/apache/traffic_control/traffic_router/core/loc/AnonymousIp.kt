...
com.fasterxml.jackson.databind.ObjectMapperimport com.google.common.net.InetAddressesimport org.apache.logging.log4j.LogManagerimport org.apache.traffic_control.traffic_router.core.ds.DeliveryServiceimport org.apache.traffic_control.traffic_router.core.edge.*import org.apache.traffic_control.traffic_router.core.loc.AnonymousIpimport
...
class AnonymousIp private constructor() {
    ...
    companion object {
        private val LOGGER = LogManager.getLogger(AnonymousIp::class.java)
	 ...
	 */   fun enforce(trafficRouter: TrafficRouter?, request: Request?, deliveryService: DeliveryService?, cache: Cache?,
            ...
            val block: Boolean = AnonymousIp.Companion.enforce(trafficRouter, deliveryService.getId(), httpRequest.requestedUrl, httpRequest.clientIP)
