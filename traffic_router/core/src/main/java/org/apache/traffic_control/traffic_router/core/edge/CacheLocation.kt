...
class CacheLocation @JvmOverloads constructor(
    ...
    constructor(id: String?, geoLocation: Geolocation?, enabledLocalizationMethods: MutableSet<LocalizationMethod?>?) : this(id, geoLocation, null, true, enabledLocalizationMethods) {}
    /**
    ...
    init {
        ...
        if (this.enabledLocalizationMethods.isEmpty()) {
            this.enabledLocalizationMethods.addAll(Arrays.asList<LocalizationMethod?>(*CacheLocation.LocalizationMethod.values()))
        }
        caches = HashMap()
    }
    ...
    companion object {
        val LOGGER = LogManager.getLogger(CacheLocation::class.java)
    }
}