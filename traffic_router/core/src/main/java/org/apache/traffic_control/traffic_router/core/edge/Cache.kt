...
import org.apache.commons.lang3.builder.EqualsBuilderimport

org.apache.commons.lang3.builder.HashCodeBuilderimport org.apache.traffic_control.traffic_router.core.config.ParseExceptionimport org.apache.traffic_control.traffic_router.core.edge.*import org.apache.traffic_control.traffic_router.core.edge.Cache.DeliveryServiceReferenceimport
...
class Cache @JvmOverloads constructor(id: String?, hashId: String?, hashCount: Int, private val geolocation: Geolocation? = null) : Node(id, hashId, hashCount) {
    ...
    class DeliveryServiceReference(deliveryServiceId: String?, fqdn: String?) {
        ...
        init {
            if (fqdn.split("\\.".toRegex(), limit = 2).toTypedArray().size != 2) {
