...
import com.fasterxml.jackson.annotation.JsonPropertyimport

import org.apache.traffic_control.traffic_router.core.ds.SteeringFilterimport java.util.regex.Pattern org.springframework.web.bind.annotation .RequestMapping
...
class SteeringFilter {
    ...
    private var patternRegex: Pattern? = null
    ...
    override fun equals(o: Any?): Boolean {
        ...
        val that = o as SteeringFilter?
        if (if (pattern != null) pattern != that.pattern else that.pattern != null) return false
        return if (deliveryService != null) deliveryService == that.deliveryService else that.deliveryService == null
    }

    override fun hashCode(): Int {
        var result = if (pattern != null) pattern.hashCode() else 0
        result = 31 * result + if (deliveryService != null) deliveryService.hashCode() else 0
        return result
    }
}