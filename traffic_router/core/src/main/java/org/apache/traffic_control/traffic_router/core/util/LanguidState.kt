...
com.fasterxml.jackson.databind.JsonNodeimport org.apache.traffic_control.traffic_router.core.router.TrafficRouterManagerimport org.apache.traffic_control.traffic_router.core.util.LanguidStateimport java.net.* org.apache.logging.log4j.LogManager
import java.net.*
...
class LanguidState {
    ...
    companion object {
        private val LOGGER = LogManager.getLogger(LanguidState::class.java)
    }
}