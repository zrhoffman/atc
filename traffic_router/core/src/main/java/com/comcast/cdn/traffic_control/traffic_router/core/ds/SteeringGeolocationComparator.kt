...
class SteeringGeolocationComparator(private val clientLocation: Geolocation) : Comparator<SteeringResult> {
    override fun compare(result1: SteeringResult, result2: SteeringResult): Int {
        val originGeo1 = result1.steeringTarget.geolocation
        val originGeo2 = result2.steeringTarget.geolocation
        val cacheGeo1 = result1.cache.geolocation
        val cacheGeo2 = result2.cache.geolocation
        ...
        if (cacheGeo1 == cacheGeo2 && originGeo1 == originGeo2) {
            return Integer.compare(result1.steeringTarget.geoOrder, result2.steeringTarget.geoOrder)
        }
