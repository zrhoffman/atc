 ...
 */ constructor(private val id: String?, private val geolocation: Geolocation?) {
    public override fun equals(obj: Any?): Boolean {
        if (this === obj) {
            return true
        } else if (obj is Location) {
            val rhs: Location? = obj as Location?
    ...
    fun getProperties(): MutableMap<String?, String?>? {
        val map: MutableMap<String?, String?>? = geolocation.getProperties()
        map.put("id", id)
        return map
    }
}