...
abstract class AbstractProtocol : Protocol {
     ...
     */
    protected var isShutdownRequested = false
    /**
     ...
     */
    var executorService: ThreadPoolExecutor? = null
    var cancelService: ExecutorService? = null
    /**
     * Gets nameServer.
     *
    ...
    protected fun query(client: InetAddress, request: ByteArray?): ByteArray {
        ...
        try {
            ...
            response = nameServer!!.query(query, client, builder)
    ...
    protected fun submit(job: SocketHandler) {
        val queueLength = executorService!!.queue.size
        val handler: Future<*>
    ...
    private fun getCanceler(handler: Future<*>): Runnable {
        return Runnable {
            try {
                handler[taskTimeout.toLong(), TimeUnit.MILLISECONDS]
