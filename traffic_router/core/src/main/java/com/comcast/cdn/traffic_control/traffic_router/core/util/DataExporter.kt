...
com.comcast.cdn.traffic_control.traffic_router.core.edge.Cacheimport com.comcast.cdn.traffic_control.traffic_router.core.edge.Location
...
com.fasterxml.jackson.databind.JsonNodeimport com.google.common.cache.CacheStats
...
class DataExporter constructor() {
    ...
    private fun getLocationFromCzm(ip: String?): Location? {
        ...
        if (locId != null) {
            ...
            val caches: MutableCollection<CacheLocation?>? = trafficRouter.getCacheRegister().getCacheLocations()
