...
class FederationsWatcher constructor() : AbstractResourceWatcher() {
    ...
    public override fun getWatcherConfigPrefix(): String? {
        return "federationmapping"
    }

    companion object {
        private val LOGGER: Logger? = Logger.getLogger(FederationsWatcher::class.java)
