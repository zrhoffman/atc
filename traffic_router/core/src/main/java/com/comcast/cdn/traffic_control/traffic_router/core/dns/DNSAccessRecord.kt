...
class DNSAccessRecord private constructor(builder: Builder) {
    val queryInstant: Long
    val client: InetAddress
    val resolver: InetAddress
    val dnsMessage: Message?
    val resultType: ResultType?
    val resultDetails: ResultDetails?
    val resultLocation: Geolocation?
    val requestNanoTime: Long

    class Builder constructor(val queryInstant: Long, var client: InetAddress) {
        val resolver: InetAddress
        var dnsMessage: Message? = null
        var resultType: ResultType? = null
        var resultDetails: ResultDetails? = null
        var resultLocation: Geolocation? = null
        val requestNanoTime: Long
        fun dnsMessage(query: Message?): Builder {
            dnsMessage = query
            return this
        }

        fun client(client: InetAddress): Builder {
            this.client = client
            return this
        }
