...
abstract class AbstractResourceWatcher constructor() : AbstractServiceUpdater() {
    ...
    protected var trafficOpsUtils: TrafficOpsUtils? = null
    ...
    fun configure(config: JsonNode?) {
        ...
        val watcherConfig: WatcherConfig = WatcherConfig(watcherConfigPrefix, config, trafficOpsUtils)
    ...
    public override fun loadDatabase(): Boolean {
        ...
        val jsonData: CharArray = CharArray(existingDB.length().toInt())
    ...
    public override fun verifyDatabase(dbFile: File): Boolean {
        ...
        val jsonData: CharArray = CharArray(dbFile.length().toInt())
    ...
    abstract val watcherConfigPrefix: String
