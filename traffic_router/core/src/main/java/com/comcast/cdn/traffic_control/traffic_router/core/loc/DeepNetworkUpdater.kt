...
class DeepNetworkUpdater constructor() : NetworkUpdater() {
    @Throws(IOException::class)
    public override fun generateTree(dbFile: File?, verifyOnly: Boolean): NetworkNode? {
        return NetworkNode.Companion.generateTree(dbFile, verifyOnly, true)
    }
