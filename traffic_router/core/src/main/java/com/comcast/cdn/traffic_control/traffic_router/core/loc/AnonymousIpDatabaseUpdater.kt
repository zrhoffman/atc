...
org.apache.log4j.Loggerimport java.io.File
class AnonymousIpDatabaseUpdater constructor() : AbstractServiceUpdater() {
    ...
    companion object {
        private val LOGGER: Logger? = Logger.getLogger(AnonymousIpDatabaseUpdater::class.java)
    }
}