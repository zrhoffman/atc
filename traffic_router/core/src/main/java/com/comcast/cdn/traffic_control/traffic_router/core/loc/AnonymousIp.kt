...
class AnonymousIp private constructor() {
	 ...
	 */  var iPv4Whitelist: AnonymousIpWhitelist? = null
        private set

    /*
	 * Returns the list of subnets in the IPv6 whitelist
	 */  var iPv6Whitelist: AnonymousIpWhitelist? = null
        private set
	 ...
	 */  var currentConfig: AnonymousIp = AnonymousIp()
            private set
        ...
        fun enforce(trafficRouter: TrafficRouter, dsvcId: String?, url: String?, ip: String?): Boolean {
            ...
            // specific policy
            if (currentConfig.blockAnonymousIp && response.isAnonymousVpn()) {
                return true
            }
            if (currentConfig.blockHostingProvider && response.isHostingProvider()) {
                return true
            }
            if (currentConfig.blockPublicProxy && response.isPublicProxy()) {
                return true
            }
            if (currentConfig.blockTorExitNode && response.isTorExitNode()) {
                return true
            }
            return false
        }
	 ...
	 */   fun enforce(
            ...
            if (block) {
                ...
                if (currentConfig.redirectUrl != null) {
                    routeResult.addUrl(URL(currentConfig.redirectUrl))
                }
            }
        }
    }
