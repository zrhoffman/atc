...
class RegionalGeoResult constructor() {
    ...
    var type: RegionalGeoResultType? = null
    var ruleType: PostalsType? = null
    var postal: String? = null
    private var usingFallbackConfig: Boolean = false
    private var allowedByWhiteList: Boolean = false
    ...
    companion object {
        val REGIONAL_GEO_DENIED_HTTP_CODE: Int = 520
    }
}