...
class FederationMapping constructor(
    val cname: String?,
    val ttl: Int,
    resolve4: ComparableTreeSet<CidrAddress?>?,
    resolve6: ComparableTreeSet<CidrAddress?>?
) : Comparable<FederationMapping?> {
    val resolve4: ComparableTreeSet<CidrAddress?>? = ComparableTreeSet()
    val resolve6: ComparableTreeSet<CidrAddress?>? = ComparableTreeSet()
    fun getResolveAddresses(cidrAddress: CidrAddress): ComparableTreeSet<CidrAddress?>? {
        return if ((cidrAddress.isIpV6())) resolve6 else resolve4
    }

    public override fun equals(o: Any?): Boolean {
        if (this === o) return true
        if (o == null || javaClass != o.javaClass) return false
        val that: FederationMapping = o as FederationMapping
        if (ttl != that.ttl) return false
        if (if (cname != null) !(cname == that.cname) else that.cname != null) return false
        if (if (resolve4 != null) !(resolve4 == that.resolve4) else that.resolve4 != null) return false
        return !(if (resolve6 != null) !(resolve6 == that.resolve6) else that.resolve6 != null)
    }

    public override fun hashCode(): Int {
        var result: Int = if (cname != null) cname.hashCode() else 0
        result = 31 * result + ttl
        result = 31 * result + (if (resolve4 != null) resolve4.hashCode() else 0)
        result = 31 * result + (if (resolve6 != null) resolve6.hashCode() else 0)
        return result
    }
    ...
    public override fun compareTo(other: FederationMapping?): Int {
        if (other == null) {
            return -1
        }
        var result: Int = cname!!.compareTo((other.cname)!!)
        if (result != 0) {
            return result
        }
    ...
    protected fun getResolveMatches(
        resolves: Set<CidrAddress?>?,
        cidrAddress: CidrAddress
    ): ComparableTreeSet<CidrAddress?> {
        val cidrAddresses: ComparableTreeSet<CidrAddress?> = ComparableTreeSet()
        for (cidrAddressResolve4: CidrAddress? in resolves!!) {
