...
class ComparableStringByLength constructor(string: String?) : Comparable<ComparableStringByLength?> {
    private val string: String
    public override fun compareTo(other: ComparableStringByLength?): Int {
    ...
    public override fun equals(other: Any?): Boolean {
        ...
        if (String::class.java == other.javaClass) {
            return (string == other)
        }
        return (string == (other as ComparableStringByLength).string)
    }
    ...
    init {
        if (string == null || string.length == 0) {
            throw IllegalArgumentException("String parameter must be non-null and non-empty")
        }
        this.string = string
    }
}