...
class RouterFilter constructor() : OncePerRequestFilter() {
    ...
    private var staticContentWhiteList: List<String>? = null
    ...
    private fun writeHttpResponse(
        ...
        try {
            ...
            val accessRequestHeaders: Map<String?, String?>? =
    ...
    private fun setMultiResponse(
        ...
        if (routeResult.getDeliveryService() != null) {
            val responseHeaders: Map<String?, String?>? = routeResult.getDeliveryService().getResponseHeaders()
    ...
    private fun setSingleResponse(
        ...
        if (routeResult.getDeliveryService() != null) {
            ...
            val responseHeaders: Map<String?, String?>? = deliveryService!!.getResponseHeaders()
            for (key: String? in responseHeaders!!.keys) {
                response.addHeader(key, responseHeaders.get(key))
            }
        }
    ...
    fun setStaticContentWhiteList(staticContentWhiteList: List<String>?) {
