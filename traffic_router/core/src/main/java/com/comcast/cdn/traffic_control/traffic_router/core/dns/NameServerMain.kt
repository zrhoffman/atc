...
com.comcast.cdn.traffic_control.traffic_router.core.dns.protocol.Protocol
...
org.apache.log4j.Loggerimport java.lang.Exception
class NameServerMain constructor() {
     ...
     */
    fun destroy() {
        for (protocol: Protocol? in getProtocols()) {
            protocol.shutdown()
        }
    ...
    companion object {
        private val LOGGER: Logger? = Logger.getLogger(NameServerMain::class.java)
        ...
        fun main(args: Array<String>) {
            try {
                val ctx: ClassPathXmlApplicationContext? = ClassPathXmlApplicationContext("/dns-traffic-router.xml")
