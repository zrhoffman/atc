...
class LocationController {
    ...
    @ResponseBody
    fun getCaches(@PathVariable("locID") locId: String?): MutableMap<String?, MutableList<CacheModel?>?>? {
        val map: MutableMap<String?, MutableList<CacheModel?>?> = HashMap()
        map["caches"] = dataExporter.getCaches(locId)
        return map
    }

    @RequestMapping(value = [""], method = [RequestMethod.GET])
    @ResponseBody
    fun getLocations(): MutableMap<String?, MutableList<String?>?>? {
        val locations: MutableMap<String?, MutableList<String?>?> = HashMap()
    ...
    @ResponseBody
    fun getCaches(): MutableMap<String?, MutableMap<String?, MutableList<CacheModel?>?>?>? {
        val map: MutableMap<String?, MutableMap<String?, MutableList<CacheModel?>?>?> = HashMap()
        val innerMap: MutableMap<String?, MutableList<CacheModel?>?> = HashMap()
