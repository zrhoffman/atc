...
class LocationController {
    ...
    @ResponseBody
    fun getCaches(@PathVariable("locID") locId: String?): Map<String, List<CacheModel?>?> {
        val map: MutableMap<String, List<CacheModel?>?> = HashMap()
    ...
    @get:ResponseBody
    @get:RequestMapping(value = ["/caches"], method = [RequestMethod.GET])
    val caches: Map<String, Map<String?, List<CacheModel?>?>>
        get() {
