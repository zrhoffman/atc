...
org.apache.log4j.Loggerimport java.net.UnknownHostExceptionimport java.util.ArrayList
open class Resolver constructor() {
    open fun resolve(fqdn: String?): MutableList<InetRecord?>? {
        var ipAddresses: MutableList<InetRecord?>? = null
        try {
            val addresses: Array<InetAddress?>? = Inet4Address.getAllByName(fqdn)
    ...
    companion object {
        private val LOGGER: Logger? = Logger.getLogger(Resolver::class.java)
    }
}