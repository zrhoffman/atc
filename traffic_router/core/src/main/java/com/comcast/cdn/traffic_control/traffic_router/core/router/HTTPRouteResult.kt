...
class HTTPRouteResult constructor(val isMultiRouteRequest: Boolean) : RouteResult {
    ...
    fun getDeliveryServices(): List<DeliveryService?> {
    ...
    val requestHeaders: Set<String?>?
        get() {
            ...
            for (deliveryService: DeliveryService? in getDeliveryServices()) {
