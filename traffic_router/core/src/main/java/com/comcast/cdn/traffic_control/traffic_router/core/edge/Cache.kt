...
class Cache @JvmOverloads constructor(
    ...
    fun getDeliveryServices(): Collection<DeliveryServiceReference> {
    ...
    public override fun setDeliveryServices(deliveryServices: Collection<DeliveryServiceReference>) {
        for (deliveryServiceReference: DeliveryServiceReference in deliveryServices) {
            this.deliveryServices.put(deliveryServiceReference.deliveryServiceId, deliveryServiceReference)
        }
    }

    public override fun hasDeliveryService(deliveryServiceId: String?): Boolean {
     ...
     */
    class DeliveryServiceReference constructor(deliveryServiceId: String?, fqdn: String) {
        val deliveryServiceId: String?
        val fqdn: String

        init {
            if (fqdn.split("\\.", 2.toBoolean()).toTypedArray().size != 2) {
