...
internal class TrafficMonitorResourceUrl constructor(
    private val trafficMonitorWatcher: TrafficMonitorWatcher,
    private val urlTemplate: String?
) : ResourceUrl {
    private var i: Int = 0
    public override fun nextUrl(): String? {
        val hosts: Array<String?>? = trafficMonitorWatcher.getHosts()
        if (hosts == null || hosts.size == 0) {
            return urlTemplate
        }
        i %= hosts.size
        val host: String? = hosts.get(i)
        i++
