...
class ProtectedFetcher constructor(authorizationEndpoint: String?, data: String, timeout: Int) : Fetcher() {
    ...
    override fun getConnection(
        ...
        if (isCookieValid) {
            val connection: HttpURLConnection? = extractCookie(super.getConnection(url, data, method, lastFetchedTime))
            if (connection!!.getResponseCode() != HttpURLConnection.HTTP_UNAUTHORIZED) {
                return connection
            }
        }
        extractCookie(super.getConnection(authorizationEndpoint, data, Fetcher.Companion.POST_STR, 0L))
    ...
    private val isCookieValid: Boolean
        private get() {
    ...
    public override fun equals(o: Any?): Boolean {
        ...
        val that: ProtectedFetcher = o as ProtectedFetcher
        ...
        return !(if (cookie != null) !(cookie == that.cookie) else that.cookie != null)
    }
