...
class CertificatesPoller constructor() : ConfigurationListener {
    ...
    private var pollingInterval: Long = defaultFixedRate
    ...
    fun start() {
        val runnable: Runnable? = label@ Runnable({
            try {
                ...
                val certificateDataList: MutableList<CertificateData?>? = certificatesClient.refreshData()
        ...
        val customFixedRate: Long? = getEnvironmentPollingInterval()
