...
class TrafficMonitorWatcher constructor() : ApplicationListener<ApplicationContextEvent?> {
    ...
    private var pollingInterval: Int = 5000
    ...
    private var statusRefreshPeriod: Int = 0
    private var configFile: String? = null
    private var configRefreshPeriod: Int = 0
    ...
    private fun processConfig() {
        ...
        if (hosts == null) {
            hosts = monitorHosts.split(";").toTypedArray()
        }
    }
    ...
    companion object {
        ...
        private var localConfig: Boolean = false
