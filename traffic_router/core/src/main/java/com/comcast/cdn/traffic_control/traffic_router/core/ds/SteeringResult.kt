...
com.comcast.cdn.traffic_control.traffic_router.core.edge.Cache
...
class SteeringResult(private var steeringTarget: SteeringTarget?, private var deliveryService: DeliveryService?) {
    private var cache: Cache? = null
    fun getSteeringTarget(): SteeringTarget? {
        return steeringTarget
    }

    fun setSteeringTarget(steeringTarget: SteeringTarget?) {
