 ...
 */
class TrafficRouterLocation constructor(id: String?, geolocation: Geolocation?) : Location(id, geolocation) {
    ...
    public override fun equals(obj: Any?): Boolean {
        if (this === obj) {
            ...
            val rhs: TrafficRouterLocation? = obj as TrafficRouterLocation?
