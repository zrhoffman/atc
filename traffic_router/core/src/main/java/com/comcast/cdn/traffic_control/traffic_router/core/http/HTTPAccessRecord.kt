...
class HTTPAccessRecord private constructor(builder: Builder?) {
    ...
    class Builder {
        ...
        fun responseCode(responseCode: Int): Builder? {
            this.responseCode = responseCode
            return this
        }

        fun responseURL(responseURL: URL?): Builder? {
            this.responseURL = responseURL
            return this
        }

        fun responseURLs(responseURLs: MutableList<URL?>?): Builder? {
            this.responseURLs = responseURLs
            return this
        }

        fun resultType(resultType: ResultType?): Builder? {
            this.resultType = resultType
            return this
        }

        fun rerr(rerr: String?): Builder? {
            this.rerr = rerr
            return this
        }

        fun resultDetails(resultDetails: ResultDetails?): Builder? {
            this.resultDetails = resultDetails
            return this
        }

        fun resultLocation(resultLocation: Geolocation?): Builder? {
            this.resultLocation = resultLocation
            return this
        }

        fun requestHeaders(requestHeaders: MutableMap<String?, String?>?): Builder? {
            this.requestHeaders = requestHeaders
            return this
        }

        fun regionalGeoResult(regionalGeoResult: RegionalGeoResult?): Builder? {
    ...
    public override fun equals(o: Any?): Boolean {
        ...
        val that: HTTPAccessRecord? = o as HTTPAccessRecord?
    ...
    public override fun hashCode(): Int {
        var result: Int = if (requestDate != null) requestDate.hashCode() else 0
        ...
        result = 31 * result + (if (responseURL != null) responseURL.hashCode() else 0)
        result = 31 * result + (if (responseURLs != null) responseURLs.hashCode() else 0)
        result = 31 * result + responseCode
        result = 31 * result + (if (resultType != null) resultType.hashCode() else 0)
        result = 31 * result + (if (rerr != null) rerr.hashCode() else 0)
        result = 31 * result + (if (resultDetails != null) resultDetails.hashCode() else 0)
        result = 31 * result + (if (resultLocation != null) resultLocation.hashCode() else 0)
        result = 31 * result + (if (requestHeaders != null) requestHeaders.hashCode() else 0)
        result = 31 * result + (if (regionalGeoResult != null) regionalGeoResult.hashCode() else 0)
        return result
    }
