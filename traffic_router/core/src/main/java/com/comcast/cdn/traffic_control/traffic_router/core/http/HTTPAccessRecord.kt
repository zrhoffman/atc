...
class HTTPAccessRecord private constructor(builder: Builder) {
    ...
    val regionalGeoResult: RegionalGeoResult?

    class Builder {
        val requestDate: Date?
        val request: HttpServletRequest?
        var responseCode: Int = -1
        var responseURL: URL? = null
        var responseURLs: List<URL?>? = null
        ...
        fun responseURLs(responseURLs: List<URL?>?): Builder {
        ...
        fun requestHeaders(requestHeaders: Map<String?, String?>?): Builder {
