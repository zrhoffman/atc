 ...
 */ constructor(private val sourceLocation: Geolocation?) : Comparator<Location> {
    /*
     * (non-Javadoc)
     * 
     * @see java.util.Comparator#compare(java.lang.Object, java.lang.Object)
     */
    public override fun compare(loc1: Location, loc2: Location): Int {
        val d1: Double = sourceLocation!!.getDistanceFrom(loc1.getGeolocation())
        val d2: Double = sourceLocation.getDistanceFrom(loc2.getGeolocation())
