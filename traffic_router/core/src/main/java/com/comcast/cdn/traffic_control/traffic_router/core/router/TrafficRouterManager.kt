...
org.apache.log4j.Loggerimport org.springframework.context.ApplicationContextimport java.net.UnknownHostException
class TrafficRouterManager constructor() : ApplicationListener<ContextRefreshedEvent?> {
    ...
    private var apiPort: Int = DEFAULT_API_PORT
    private var secureApiPort: Int = DEFAULT_SECURE_API_PORT
    ...
    fun setCacheRegister(cacheRegister: CacheRegister?) {
        ...
        val tr: TrafficRouter? = TrafficRouter(
            cacheRegister,
            geolocationService,
            geolocationService6,
            anonymousIpService,
    ...
    public override fun onApplicationEvent(event: ContextRefreshedEvent?) {
    ...
    companion object {
        private val LOGGER: Logger? = Logger.getLogger(TrafficRouterManager::class.java)
        val DEFAULT_API_PORT: Int = 3333
        val DEFAULT_SECURE_API_PORT: Int = 0 // Must be set through server.xml properties
