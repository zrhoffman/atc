...
class AnonymousIpWhitelistTest constructor() {
    ...
    fun badIPv4Input1() {
        val mapper: ObjectMapper? = ObjectMapper()
        val badlist: AnonymousIpWhitelist? = AnonymousIpWhitelist()
	...
	*/
    ...
    fun testAddSubnets() {
        val whitelist: AnonymousIpWhitelist? = AnonymousIpWhitelist()
