...
class RequestMatcherTest constructor() {
    @Test
    ...
    fun itMatchesByHost() {
        ...
        val requestMatcher: RequestMatcher? = RequestMatcher(DeliveryServiceMatcher.Type.HOST, ".*\\.host\\..*", "")
    ...
    @Test
    fun itMatchesByPath() {
        val requestMatcher: RequestMatcher? = RequestMatcher(DeliveryServiceMatcher.Type.PATH, ".*path.*")
        val request: Request? = Request()
        MatcherAssert.assertThat(requestMatcher.matches(request), Matchers.equalTo(false))
    ...
    fun itMatchesByQuery() {
        val requestMatcher: RequestMatcher? = RequestMatcher(DeliveryServiceMatcher.Type.PATH, ".*car=red.*")
        val request: Request? = Request()
        MatcherAssert.assertThat(requestMatcher.matches(request), Matchers.equalTo(false))
        val httpRequest: HTTPRequest? = HTTPRequest()
        httpRequest.setPath("/foo/path/bar")
    ...
    fun itMatchesByPathAndQuery() {
        val requestMatcher: RequestMatcher? =
            RequestMatcher(DeliveryServiceMatcher.Type.PATH, "\\/foo\\/path\\/bar\\?car=red")
        val request: Request? = Request()
        MatcherAssert.assertThat(requestMatcher.matches(request), Matchers.equalTo(false))
        val httpRequest: HTTPRequest? = HTTPRequest()
        httpRequest.setPath("/foo/path/bar")
    ...
    fun itMatchesByRequestHeader() {
        val requestMatcher: RequestMatcher? =
            RequestMatcher(DeliveryServiceMatcher.Type.HEADER, ".*kabletown.*", "Host")
        val request: Request? = Request()
        MatcherAssert.assertThat(requestMatcher.matches(request), Matchers.equalTo(false))
    ...
    fun itSupportsOrderingByItsRegex() {
        val requestMatcher1: RequestMatcher? = RequestMatcher(DeliveryServiceMatcher.Type.PATH, ".*abcd.*")
        val requestMatcher2: RequestMatcher? = RequestMatcher(DeliveryServiceMatcher.Type.PATH, ".*abcde.*")
        val requestMatcher3: RequestMatcher? = RequestMatcher(DeliveryServiceMatcher.Type.PATH, ".*bcd.*")
        val requestMatcher4: RequestMatcher? = RequestMatcher(DeliveryServiceMatcher.Type.PATH, ".*bcdef.*")
        ...
        val iterator: MutableIterator<RequestMatcher?>? = set.iterator()
    ...
    fun itSupportsEquals() {
        val requestMatcher1: RequestMatcher? = RequestMatcher(DeliveryServiceMatcher.Type.HOST, ".*abc.*")
        val requestMatcher2: RequestMatcher? = RequestMatcher(DeliveryServiceMatcher.Type.HOST, ".*abc.*")
