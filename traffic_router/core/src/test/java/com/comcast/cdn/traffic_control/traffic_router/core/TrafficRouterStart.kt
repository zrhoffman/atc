...
object TrafficRouterStart {
    ...
    fun main(args: Array<String>) {
        var prefix: String? = System.getProperty("user.dir")
        ...
        val catalinaTrafficRouter: CatalinaTrafficRouter? =
            CatalinaTrafficRouter(prefix + "/src/main/conf/server.xml", prefix + "/src/main/webapp")
