...
class FetcherTest constructor() {
    @Test
    @Throws(Exception::class)
    fun itChecksIfDataHasChangedSinceLastFetch() {
        val inputStream: InputStream? = PowerMockito.mock(InputStream::class.java)
        val inputStreamReader: InputStreamReader? = PowerMockito.mock(InputStreamReader::class.java)
        PowerMockito.whenNew(InputStreamReader::class.java).withArguments(inputStream).thenReturn(inputStreamReader)
        val bufferedReader: BufferedReader? = PowerMockito.mock(BufferedReader::class.java)
        ...
        val httpURLConnection: HttpURLConnection? = PowerMockito.mock(HttpURLConnection::class.java)
        ...
        Mockito.verify(httpURLConnection).setIfModifiedSince(123456L)
    }
}