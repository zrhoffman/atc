...
class AbstractServiceUpdaterTest constructor() {
    ...
    fun before() {
        ...
        val url: URL? = PowerMockito.mock(URL::class.java)
    ...
    internal inner class Updater constructor() : AbstractServiceUpdater() {
