...
class ComparableStringByLengthTest constructor() {
    @Test
    ...
    fun itSortsAscendingToShorterStrings() {
        ...
        val iterator: MutableIterator<ComparableStringByLength?>? = set.iterator()
    ...
    fun itProperlySupportsEquals() {
        val abc: ComparableStringByLength? = ComparableStringByLength("abc")
        val def: ComparableStringByLength? = abc
        MatcherAssert.assertThat((abc == def), Matchers.equalTo(true))
