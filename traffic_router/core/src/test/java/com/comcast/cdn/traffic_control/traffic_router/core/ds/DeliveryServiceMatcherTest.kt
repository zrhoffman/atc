...
class DeliveryServiceMatcherTest constructor() {
    @Test
    fun itReturnsTrueWhenAllMatchersPass() {
        val deliveryServiceMatcher: DeliveryServiceMatcher? = DeliveryServiceMatcher(
            Mockito.mock(
    ...
    fun itComparesByMatchRegexes() {
        ...
        val deliveryServiceMatcher1: DeliveryServiceMatcher? = DeliveryServiceMatcher(deliveryService)
        ...
        val deliveryServiceMatcher1a: DeliveryServiceMatcher? = DeliveryServiceMatcher(deliveryService)
        ...
        val deliveryServiceMatcher2: DeliveryServiceMatcher? = DeliveryServiceMatcher(deliveryService)
    ...
    fun compareToReturns0WhenSameMatchersDifferentDeliveryServices() {
        val deliveryService1: DeliveryService? = Mockito.mock(DeliveryService::class.java)
        Mockito.`when`(deliveryService1.getId()).thenReturn("delivery service 1")
        val deliveryService2: DeliveryService? = Mockito.mock(DeliveryService::class.java)
        Mockito.`when`(deliveryService2.getId()).thenReturn("delivery service 2")
        val deliveryServiceMatcher1: DeliveryServiceMatcher? = DeliveryServiceMatcher(deliveryService1)
        deliveryServiceMatcher1.addMatch(DeliveryServiceMatcher.Type.HOST, ".*\\.service01-kabletown.com\\..*", "")
        deliveryServiceMatcher1.addMatch(DeliveryServiceMatcher.Type.PATH, ".*abc.*", "")
        val deliveryServiceMatcher2: DeliveryServiceMatcher? = DeliveryServiceMatcher(deliveryService2)
        deliveryServiceMatcher2.addMatch(DeliveryServiceMatcher.Type.HOST, ".*\\.service01-kabletown.com\\..*", "")
