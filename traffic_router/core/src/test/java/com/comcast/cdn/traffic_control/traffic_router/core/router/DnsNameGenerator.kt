...
class DnsNameGenerator {
    ...
    fun getNames(deliveryServicesConfig: JsonNode?, cdnConfig: JsonNode?): MutableList<String?>? {
        val names: MutableList<String?> = ArrayList()
        val domainName = cdnConfig.get("domain_name").asText()
        for (matchsets in deliveryServicesConfig.get("matchsets")) {
