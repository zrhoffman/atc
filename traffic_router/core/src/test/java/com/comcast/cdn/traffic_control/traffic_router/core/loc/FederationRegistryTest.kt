...
class FederationRegistryTest constructor() {
    ...
    fun before() {
        ...
        val cidrAddressesIpV4: ComparableTreeSet<CidrAddress?>? = ComparableTreeSet()
        ...
        val cidrAddressesIpV6: ComparableTreeSet<CidrAddress?>? = ComparableTreeSet()
        cidrAddressesIpV6.add(cidrAddress3)
        cidrAddressesIpV6.add(cidrAddress4)
        val federationMapping: FederationMapping? =
            FederationMapping("cname1", 1234, cidrAddressesIpV4, cidrAddressesIpV6)
        val federationMappings: MutableList<FederationMapping?>? = ArrayList()
        federationMappings.add(federationMapping)
        val federation: Federation? = Federation("kable-town-01", federationMappings)
    ...
    @Throws(Exception::class)
    fun itFindsMapping() {
        val federationRegistry: FederationRegistry? = FederationRegistry()
        federationRegistry.setFederations(federations)
        var inetRecords: MutableList<InetRecord?>? =
