...
class RegionalGeoRuleTest constructor() {
    @Test
    @Throws(Exception::class)
    fun testIsAllowedCoordinateRanges() {
        val urlRegex: String? = ".*abc.m3u8"
        val ruleType: PostalsType? = PostalsType.INCLUDE
        val postals: MutableSet<String?>? = HashSet()
        val whiteList: NetworkNode? = SuperNode()
        val alternateUrl: String? = "/alternate.m3u8"
        val coordinateRanges: ArrayList<RegionalGeoCoordinateRange?>? = ArrayList()
        val coordinateRange: RegionalGeoCoordinateRange? = RegionalGeoCoordinateRange()
        val coordinateRange2: RegionalGeoCoordinateRange? = RegionalGeoCoordinateRange()
        ...
        val urlRegexPattern: Pattern? = Pattern.compile(urlRegex, Pattern.CASE_INSENSITIVE)
    ...
    fun testMatchesUrl() {
        ...
        var matches: Boolean
        var url: String? = "http://example.com/abc.m3u8"
    ...
    fun testIsAllowedPostalExclude() {
        val urlRegex: String? = ".*abc.m3u8"
        val ruleType: PostalsType? = PostalsType.EXCLUDE
        val postals: MutableSet<String?>? = HashSet()
        postals.add("N6G")
        postals.add("N7G")
        val whiteList: NetworkNode? = SuperNode()
    ...
    fun testIsInWhiteList() {
        ...
        val ruleType: PostalsType? = PostalsType.EXCLUDE
        val postals: MutableSet<String?>? = HashSet()
        val whiteList: SuperNode? = SuperNode()
        val location: String? = RegionalGeoRule.Companion.WHITE_LIST_NODE_LOCATION
