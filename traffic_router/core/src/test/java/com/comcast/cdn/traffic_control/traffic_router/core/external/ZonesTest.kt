...
class ZonesTest constructor() {
    ...
    fun itGetsStatsForZones() {
        val httpGet: HttpGet? = HttpGet("http://localhost:3333/crs/stats/zones/caches")
        ...
        try {
            ...
            val dynamicZonesStats: MutableMap<String?, Any?>? =
                zoneStats.get("dynamicZoneCaches") as MutableMap<String?, Any?>?
            ...
            val staticZonesStats: MutableMap<String?, Any?>? =
                zoneStats.get("staticZoneCaches") as MutableMap<String?, Any?>?
            MatcherAssert.assertThat(
