...
class FederationMappingBuilderTest {
    ...
    fun itConsumesValidJSON() {
        ...
        MatcherAssert.assertThat(federationMapping.resolve4,
                Matchers.containsInAnyOrder(CidrAddress.Companion.fromString("192.168.45.67/24"), CidrAddress.Companion.fromString("192.168.56.78/24")))
        MatcherAssert.assertThat(federationMapping.resolve6,
                Matchers.containsInAnyOrder(CidrAddress.Companion.fromString("fd12:3456:789a:1::/64"), CidrAddress.Companion.fromString("fdfe:dcba:9876:5::/64")))
    }
