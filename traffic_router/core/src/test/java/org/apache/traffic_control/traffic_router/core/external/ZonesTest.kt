...
class ZonesTest {
    ...
    fun itGetsStatsForZones() {
        ...
        try {
            ...
            val zoneStats: MutableMap<String?, Any?>? = ObjectMapper().readValue(actual, object : TypeReference<HashMap<String?, Any?>?>() {})
            val dynamicZonesStats = zoneStats.get("dynamicZoneCaches") as MutableMap<String?, Any?>?
            MatcherAssert.assertThat(dynamicZonesStats.keys, Matchers.containsInAnyOrder("requestCount", "evictionCount", "totalLoadTime",
            ...
            MatcherAssert.assertThat(staticZonesStats.keys, Matchers.containsInAnyOrder("requestCount", "evictionCount", "totalLoadTime",
                    "averageLoadPenalty", "hitCount", "loadSuccessCount", "missRate", "loadExceptionRate", "hitRate", "missCount", "loadCount", "loadExceptionCount"))
        } finally {
            response?.close()
        }
