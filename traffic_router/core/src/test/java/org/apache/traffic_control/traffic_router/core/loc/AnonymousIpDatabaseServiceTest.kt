...
org.hamcrest.CoreMatchersimport org.hamcrest.MatcherAssertimport org.junit.*import java.io.*
...
class AnonymousIpDatabaseServiceTest {
    ...
    fun testIpInDatabase() {
        MatcherAssert.assertThat(anonymousIpService.lookupIp(InetAddress.getByName("223.26.48.248")), CoreMatchers.notNullValue())
        MatcherAssert.assertThat(anonymousIpService.lookupIp(InetAddress.getByName("223.26.48.248")), CoreMatchers.notNullValue())
        MatcherAssert.assertThat(anonymousIpService.lookupIp(InetAddress.getByName("1.1.205.152")), CoreMatchers.notNullValue())
        MatcherAssert.assertThat(anonymousIpService.lookupIp(InetAddress.getByName("18.85.22.204")), CoreMatchers.notNullValue())
    }

    @Test
    @Throws(Exception::class)
    fun testIpNotInDatabase() {
        MatcherAssert.assertThat(anonymousIpService.lookupIp(InetAddress.getByName("192.168.0.1")), CoreMatchers.equalTo(null))
    }
    ...
    fun testDatabaseNotLoaded() {
        ...
        MatcherAssert.assertThat(anonymousIpService.lookupIp(InetAddress.getByName("223.26.48.248")), CoreMatchers.equalTo(null))
        MatcherAssert.assertThat(anonymousIpService.lookupIp(InetAddress.getByName("192.168.0.1")), CoreMatchers.equalTo(null))
    }
    ...
    fun testLookupTime() {
        ...
        println(String.format("Anonymous IP database average lookup: %s nanoseconds", java.lang.Long.toString(duration / total)))
    }
    ...
    companion object {
        private val mmdb: String? = "src/test/resources/GeoIP2-Anonymous-IP.mmdb"
    }
}