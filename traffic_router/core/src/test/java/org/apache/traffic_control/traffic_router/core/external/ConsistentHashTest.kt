...
class ConsistentHashTest {
    ...
    fun itAppliesConsistentHashingToRequestsForCoverageZone() {
        ...
        try {
            ...
            var httpGet = HttpGet("http://localhost:3333/crs/consistenthash/cache/coveragezone?ip=$ipAddressInCoverageZone&deliveryServiceId=$deliveryServiceId&requestPath=$requestPath")
            response = closeableHttpClient.execute(httpGet)
            Assert.assertThat("Expected to find $ipAddressInCoverageZone in coverage zone using delivery service id $deliveryServiceId", response.statusLine.statusCode, IsEqual.equalTo(200))
            val objectMapper = ObjectMapper(JsonFactory())
            ...
            httpGet = HttpGet("http://localhost:3333/crs/consistenthash/cache/coveragezone?ip=$ipAddressInCoverageZone&deliveryServiceId=$deliveryServiceId&requestPath=$requestPath")
            response = closeableHttpClient.execute(httpGet)
            cacheNode = objectMapper.readTree(EntityUtils.toString(response.entity))
    ...
    fun itAppliesConsistentHashingForRequestsOutsideCoverageZone() {
        ...
        try {
            var requestPath = URLEncoder.encode("/some/path/thing", "UTF-8")
            var httpGet = HttpGet("http://localhost:3333/crs/consistenthash/cache/geolocation?ip=8.8.8.8&deliveryServiceId=$deliveryServiceId&requestPath=$requestPath")
            response = closeableHttpClient.execute(httpGet)
            ...
            response.close()
            requestPath = URLEncoder.encode("/another/different/path", "UTF-8")
            httpGet = HttpGet("http://localhost:3333/crs/consistenthash/cache/geolocation?ip=8.8.8.8&deliveryServiceId=$deliveryServiceId&requestPath=$requestPath")
            response = closeableHttpClient.execute(httpGet)
            cacheNode = objectMapper.readTree(EntityUtils.toString(response.entity))
            Assert.assertThat(cacheNode["id"].asText(), IsNot.not(IsEqual.equalTo(cacheId)))
            Assert.assertThat(cacheNode["id"].asText(), IsNot.not(IsEqual.equalTo("")))
    ...
    fun itAppliesConsistentHashingToSteeringDeliveryService() {
        ...
        try {
            ...
            val httpGet = HttpGet("http://localhost:3333/crs/consistenthash/deliveryservice?ip=98.76.54.123&deliveryServiceId=$steeringDeliveryServiceId&requestPath=$requestPath")
            response = closeableHttpClient.execute(httpGet)
            val objectMapper = ObjectMapper(JsonFactory())
    ...
    fun itUsesBypassFiltersWithDeliveryServiceSteering() {
        ...
        try {
            ...
            var httpGet = HttpGet("http://localhost:3333/crs/consistenthash/deliveryservice?ip=98.76.54.123&deliveryServiceId=$steeringDeliveryServiceId&requestPath=$requestPath")
            response = closeableHttpClient.execute(httpGet)
            val objectMapper = ObjectMapper(JsonFactory())
            ...
            httpGet = HttpGet("http://localhost:3333/crs/consistenthash/deliveryservice?ip=98.76.54.123&deliveryServiceId=$steeringDeliveryServiceId&requestPath=$requestPath")
            response = closeableHttpClient.execute(httpGet)
    ...
    fun itUsesRegexToStandardizeRequestPath() {
        ...
        try {
            ...
            var httpGet = HttpGet("http://localhost:3333/crs/consistenthash/patternbased/regex?regex=$encodedConsistentHashRegex&requestPath=$requestPath")
            response = closeableHttpClient.execute(httpGet)
            Assert.assertThat("Expected to get 200 response from /consistenthash/patternbased/regex endpoint", response.statusLine.statusCode, IsEqual.equalTo(200))
            val objectMapper = ObjectMapper(JsonFactory())
            ...
            httpGet = HttpGet("http://localhost:3333/crs/consistenthash/patternbased/regex?regex=$encodedConsistentHashRegex&requestPath=$requestPath")
            response = closeableHttpClient.execute(httpGet)
            resp = objectMapper.readTree(EntityUtils.toString(response.entity))
            Assert.assertThat(optString(resp, "resultingPathToConsistentHash"), IsEqual.equalTo(resultingPathToConsistentHash))
        } finally {
            response?.close()
        }
    }
    ...
    fun itAppliesPatternBasedConsistentHashingToSteeringRequestsForCoverageZone() {
        ...
        try {
            var requestPath = URLEncoder.encode("/some/path/thing.m3u8", "UTF-8")
            var httpGet = HttpGet("http://localhost:3333/crs/consistenthash/cache/coveragezone/steering?ip=$ipAddressInCoverageZone&deliveryServiceId=$steeringDeliveryServiceId&requestPath=$requestPath")
            response = closeableHttpClient.execute(httpGet)
            Assert.assertThat("Expected to find $ipAddressInCoverageZone in coverage zone using delivery service id $deliveryServiceId", response.statusLine.statusCode, IsEqual.equalTo(200))
            val objectMapper = ObjectMapper(JsonFactory())
            var cacheNode = objectMapper.readTree(EntityUtils.toString(response.entity))
            ...
            response.close()
            requestPath = URLEncoder.encode("/other_different_path_12344321/path/other_thing_to_hash_differently.m3u8", "UTF-8")
            httpGet = HttpGet("http://localhost:3333/crs/consistenthash/cache/coveragezone/steering?ip=$ipAddressInCoverageZone&deliveryServiceId=$steeringDeliveryServiceId&requestPath=$requestPath")
            response = closeableHttpClient.execute(httpGet)
            cacheNode = objectMapper.readTree(EntityUtils.toString(response.entity))
            Assert.assertThat(cacheNode["id"].asText(), IsEqual.equalTo(cacheId))
        } finally {
