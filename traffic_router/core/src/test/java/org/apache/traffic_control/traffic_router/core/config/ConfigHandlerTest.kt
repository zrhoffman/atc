 ...
 */
package org.apache.traffic_control.traffic_router.core.configimport
...
class ConfigHandlerTest {
    ...
    fun itTestRelativeUrl() {
        ...
        Mockito.doAnswer { invocation ->
            ...
            null
        }.`when`(ds).geoRedirectFile = ArgumentMatchers.anyString()
        Mockito.doAnswer { invocation ->
            val args = invocation.arguments
            urlType[0] = args[0] as String
            null
        }.`when`(ds).geoRedirectUrlType = ArgumentMatchers.anyString()
        dsMap[dsId] = ds
        ...
        MatcherAssert.assertThat(urlType[0], Matchers.equalTo("DS_URL"))
        MatcherAssert.assertThat(typeUrl[0], Matchers.equalTo(""))
    }
    ...
    fun itTestRelativeUrlNegative() {
        ...
        val register = PowerMockito.mock(CacheRegister::class.java)
        Whitebox.invokeMethod<Any?>(handler, "initGeoFailedRedirect", dsMap, register)
        MatcherAssert.assertThat(urlType[0], Matchers.equalTo(""))
        MatcherAssert.assertThat(typeUrl[0], Matchers.equalTo(""))
    }
    ...
    fun itTestNoSuchDsUrl() {
        ...
        dsMap[dsId] = ds
        val register = PowerMockito.mock(CacheRegister::class.java)
        Mockito.`when`(register.getDeliveryService(ArgumentMatchers.any(HTTPRequest::class.java))).thenReturn(null)
        Whitebox.invokeMethod<Any?>(handler, "initGeoFailedRedirect", dsMap, register)
        MatcherAssert.assertThat(urlType[0], Matchers.equalTo("NOT_DS_URL"))
        MatcherAssert.assertThat(typeUrl[0], Matchers.equalTo(path))
    }
    ...
    fun itTestNotThisDsUrl() {
        ...
        val register = PowerMockito.mock(CacheRegister::class.java)
        Mockito.`when`(register.getDeliveryService(ArgumentMatchers.any(HTTPRequest::class.java))).thenReturn(anotherDs)
        Whitebox.invokeMethod<Any?>(handler, "initGeoFailedRedirect", dsMap, register)
        MatcherAssert.assertThat(urlType[0], Matchers.equalTo("NOT_DS_URL"))
        MatcherAssert.assertThat(typeUrl[0], Matchers.equalTo(path))
    }
    ...
    fun itTestThisDsUrl() {
        ...
        dsMap[dsId] = ds
        val register = PowerMockito.mock(CacheRegister::class.java)
        Mockito.`when`(register.getDeliveryService(ArgumentMatchers.any(HTTPRequest::class.java))).thenReturn(ds)
        Whitebox.invokeMethod<Any?>(handler, "initGeoFailedRedirect", dsMap, register)
        MatcherAssert.assertThat(urlType[0], Matchers.equalTo("DS_URL"))
        MatcherAssert.assertThat(typeUrl[0], Matchers.equalTo(path))
    }
    ...
    fun itParsesTheTopologiesConfig() {
        ...
        MatcherAssert.assertThat(dsReferences.size, Matchers.equalTo(1))
        MatcherAssert.assertThat(dsReferences.iterator().next().deliveryServiceId, Matchers.equalTo(dsId))
    }
    ...
    fun testParseLocalizationMethods() {
        ...
        var actual = Whitebox.invokeMethod<MutableSet<LocalizationMethod?>?>(handler, "parseLocalizationMethods", "foo", allMethodsJson)
