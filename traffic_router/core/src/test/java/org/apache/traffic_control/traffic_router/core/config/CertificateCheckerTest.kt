...
class CertificateCheckerTest {
    ...
    fun itReturnsFalseWhenDeliveryServiceNameIsNull() {
        ...
        MatcherAssert.assertThat(certificateChecker.certificatesAreValid(certificateDataList, deliveryServicesJson), Matchers.equalTo(false))
    }
    ...
    fun itReturnsTrueWhenAllHttpsDeliveryServicesHaveCertificates() {
        ...
        deliveryServicesJson = mapper.readTree(file)
        val certificateChecker = CertificateChecker()
        MatcherAssert.assertThat(certificateChecker.certificatesAreValid(certificateDataList, deliveryServicesJson), Matchers.equalTo(true))
    }
