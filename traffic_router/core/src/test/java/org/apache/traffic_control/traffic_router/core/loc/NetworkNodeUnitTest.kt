...
class NetworkNodeUnitTest {
    ...
    fun itPutsNetworksIntoOrderedHierarchy() {
        ...
        root.add(subnet2)
        root.add(subnet1)
        val iterator: MutableIterator<MutableMap.MutableEntry<NetworkNode?, NetworkNode?>?> = net.children.entries.iterator()
    ...
    fun itPutsAllSubnetsUnderSuperNet() {
        ...
        val iterator: MutableIterator<MutableMap.MutableEntry<NetworkNode?, NetworkNode?>?> = generation1Node.children.entries.iterator()
        ...
        MatcherAssert.assertThat(generation2SecondNode.toString(), Matchers.equalTo("[192.168.55.0/24] - location:null"))
    }
