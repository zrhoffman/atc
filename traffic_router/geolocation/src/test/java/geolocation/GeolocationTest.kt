...
class GeolocationTest constructor() {
    @Before
    ...
    fun testGetDistanceFrom() {
        val l1: Geolocation? = Geolocation(0f, 0f)
        val l2: Geolocation? = Geolocation(.5f, .5f)
        val expected: Double = 78.6
        val actual: Double = l1.getDistanceFrom(l2)
        Assert.assertEquals(expected, actual, 0.1)
    }

    @Test
    fun testGetDistanceFromEquator() {
        val l1: Geolocation? = Geolocation(1f, 0f)
        val l2: Geolocation? = Geolocation(-1f, 0f)
        val expected: Double = 222.4
        val actual: Double = l1.getDistanceFrom(l2)
        Assert.assertEquals(expected, actual, 0.1)
    }
    ...
    fun testGetDistanceFromIntlDateLine() {
        val l1: Geolocation? = Geolocation(0f, 179f)
        val l2: Geolocation? = Geolocation(0f, -179f)
        val expected: Double = 222.4
        val actual: Double = l1.getDistanceFrom(l2)
        Assert.assertEquals(expected, actual, 0.1)
    }
    ...
    fun testGetDistanceFromNull() {
        val l1: Geolocation? = Geolocation(0f, 1f)
    ...
    fun testGetDistanceFromPrimeMeridian() {
        val l1: Geolocation? = Geolocation(0f, 1f)
        val l2: Geolocation? = Geolocation(0f, -1f)
        val expected: Double = 222.4
        val actual: Double = l1.getDistanceFrom(l2)
        Assert.assertEquals(expected, actual, 0.1)
    }
