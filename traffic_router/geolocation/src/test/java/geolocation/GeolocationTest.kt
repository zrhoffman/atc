...
class GeolocationTest {
    ...
    fun testGetDistanceFrom() {
        val l1 = Geolocation(0.0, 0.0)
        val l2 = Geolocation(.5, .5)
        val expected = 78.6
    ...
    fun testGetDistanceFromEquator() {
        val l1 = Geolocation(1.0, 0.0)
        val l2 = Geolocation(-1.0, 0.0)
        val expected = 222.4
        val actual = l1.getDistanceFrom(l2)
        Assert.assertEquals(expected, actual, 0.1)
    }
    ...
    fun testGetDistanceFromIntlDateLine() {
        val l1 = Geolocation(0.0, 179.0)
        val l2 = Geolocation(0.0, -179.0)
        val expected = 222.4
        val actual = l1.getDistanceFrom(l2)
        Assert.assertEquals(expected, actual, 0.1)
    }
