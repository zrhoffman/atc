 ...
 * @param longitude
 * in decimal degrees
 */ constructor(private val latitude: Double, private val longitude: Double) {
    private var postalCode: String? = null
    private var city: String? = null
    private var countryCode: String? = null
    private var countryName: String? = null
    private var defaultLocation: Boolean = false
    fun getProperties(): MutableMap<String?, String?>? {
        val map: MutableMap<String?, String?>? = HashMap()
        map.put("latitude", java.lang.Double.toString(latitude))
        map.put("longitude", java.lang.Double.toString(longitude))
    ...
    fun getDistanceFrom(other: Geolocation?): Double {
        if (other != null) {
            val dLat: Double = Math.toRadians(getLatitude() - other.getLatitude())
            val dLon: Double = Math.toRadians(getLongitude() - other.getLongitude())
    ...
    public override fun equals(obj: Any?): Boolean {
        if (this === obj) {
            ...
            val rhs: Geolocation? = obj as Geolocation?
    ...
    companion object {
        private val MEAN_EARTH_RADIUS: Double = 6371.0
    }
}