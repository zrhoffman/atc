...
class TrafficRouterConfigurationListener constructor() : ConfigurationListener {
    ...
    fun configurationChanged() {
        ...
        val prefix: String? = if (restarting) "Restarting" else "Starting"
        logger.warn(prefix.toString() + " Neustar remote database refresher at rate " + fixedRate + " msec")
    }
}