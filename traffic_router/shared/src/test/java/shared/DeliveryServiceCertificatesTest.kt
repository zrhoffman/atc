...
class DeliveryServiceCertificatesTest constructor() {
    @Before
    ...
    fun itSendsNotificationWhenNewCertData() {
        val deliveryServiceCertificates: DeliveryServiceCertificates? = Mockito.spy(DeliveryServiceCertificates())
        val captor: ArgumentCaptor<AttributeChangeNotification?>? = ArgumentCaptor.forClass(
        ...
        val notification: AttributeChangeNotification? = captor.getValue()
        MatcherAssert.assertThat(notification.getNewValue(), CoreMatchers.equalTo(certificateDataList))
        MatcherAssert.assertThat(notification.getAttributeName(), CoreMatchers.equalTo("CertificateDataList"))
        MatcherAssert.assertThat(notification.getAttributeType(), CoreMatchers.equalTo("List<CertificateData>"))
        MatcherAssert.assertThat(notification.getMessage(), CoreMatchers.equalTo("CertificateDataList Changed"))
        MatcherAssert.assertThat(notification.getTimeStamp(), CoreMatchers.equalTo(1234L))
        MatcherAssert.assertThat(notification.getSequenceNumber(), CoreMatchers.equalTo(1L))
        MatcherAssert.assertThat(notification.getSource(), CoreMatchers.equalTo(deliveryServiceCertificates))
    }
}