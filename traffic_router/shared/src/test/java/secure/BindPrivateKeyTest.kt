...
class BindPrivateKeyTest constructor() {
    ...
    fun before() {
        ...
        val privateCrtKey: RSAPrivateCrtKeyImpl? = keyPair.getPrivate() as RSAPrivateCrtKeyImpl?
        ...
        val keyFactory: KeyFactory? = PowerMockito.mock(KeyFactory::class.java)
        PowerMockito.mockStatic(KeyFactory::class.java)
        PowerMockito.`when`(KeyFactory.getInstance("RSA")).thenReturn(keyFactory)
        val spec: RSAPrivateCrtKeySpec? = Mockito.mock(RSAPrivateCrtKeySpec::class.java)
    ...
    fun itDecodesPrivateKeyString() {
        val key: PrivateKey? = BindPrivateKey().decode(privateKeyString)
