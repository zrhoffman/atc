...
class DeliveryServiceCertificates constructor() : NotificationBroadcasterSupport(), DeliveryServiceCertificatesMBean {
    private var certificateDataList: MutableList<CertificateData?>? = null
    private var sequenceNumber: Long = 1L
    public override fun getCertificateDataList(): MutableList<CertificateData?>? {
        return certificateDataList
    }

    public override fun setCertificateDataList(certificateDataList: MutableList<CertificateData?>?) {
        val oldCertificateDataList: MutableList<CertificateData?>? = this.certificateDataList
    ...
    public override fun setCertificateDataListString(certificateDataListString: String?) {
        try {
            val certificateDataList: MutableList<CertificateData?>? = ObjectMapper().readValue(
    ...
    public override fun equals(o: Any?): Boolean {
        ...
        val that: DeliveryServiceCertificates? = o as DeliveryServiceCertificates?
    ...
    public override fun hashCode(): Int {
        var result: Int = if (certificateDataList != null) certificateDataList.hashCode() else 0
