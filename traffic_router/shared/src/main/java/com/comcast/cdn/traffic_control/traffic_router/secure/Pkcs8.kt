...
class Pkcs8 constructor(data: String?) : Pkcs(data) {
    public override fun getHeader(): String? {
        return HEADER
    }

    public override fun getFooter(): String? {
        return FOOTER
    }
    ...
    override fun decodeKeySpec(data: String?): KeySpec? {
        try {
            ...
            LOGGER.error(
                "Failed to create PKCS8 Encoded Key Spec " + e.javaClass.getCanonicalName() + ": " + e.message,
                e
            )
        }
        return null
    ...
    companion object {
        private val LOGGER: Logger? = Logger.getLogger(Pkcs8::class.java)
