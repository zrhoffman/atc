...
class DeliveryServiceCertificates : NotificationBroadcasterSupport(), DeliveryServiceCertificatesMBean {
    ...
    override fun setCertificateDataList(certificateDataList: MutableList<CertificateData?>?) {
        ...
        sendNotification(AttributeChangeNotification(this, sequenceNumber, System.currentTimeMillis(), "CertificateDataList Changed",
    ...
    override fun setCertificateDataListString(certificateDataListString: String?) {
        try {
            val certificateDataList = ObjectMapper().readValue(certificateDataListString, object : TypeReference<MutableList<CertificateData?>?>() {})
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + (sequenceNumber xor (sequenceNumber ushr 32)).toInt()
        return result
    }
}