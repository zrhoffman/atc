...
class Pkcs8(data: String?) : Pkcs(data) {
    override fun getHeader(): String? {
        return Pkcs8.Companion.HEADER
    }

    override fun getFooter(): String? {
        return Pkcs8.Companion.FOOTER
    }
    ...
    override fun decodeKeySpec(data: String?): KeySpec? {
        try {
            ...
            Pkcs8.Companion.LOGGER.error("Failed to create PKCS8 Encoded Key Spec " + e.javaClass.canonicalName + ": " + e.message, e)
        }
        return null
    }

    companion object {
        private val LOGGER = LogManager.getLogger(Pkcs8::class.java)
