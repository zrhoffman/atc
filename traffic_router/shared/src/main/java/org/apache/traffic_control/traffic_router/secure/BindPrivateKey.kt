...
class BindPrivateKey {
    ...
    fun decode(data: String?): PrivateKey? {
        ...
        try {
            ...
            BindPrivateKey.Companion.LOGGER.error("Failed to decode Bind Private Key data: " + e.message, e)
        }
        return null
    }

    companion object {
        private val LOGGER = LogManager.getLogger(BindPrivateKey::class.java)
    }
}