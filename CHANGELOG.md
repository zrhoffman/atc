...
- [Flexible Topologies (in progress)](https://github.com/apache/trafficcontrol/blob/master/blueprints/flexible-topologies.md)
    ...
    - Traffic Ops: Added an API 3.0 endpoint, `POST /api/3.0/topologyes/{name}/queue_update`, to queue or dequeue updates for all servers assigned to the Cachegroups in a given Topology.
    ...
    - Traffic Portal: Added the ability to create, read, update and delete a topology.
    - Traffic Portal: Added the ability to queue updates for all topology servers for a given CDN.
