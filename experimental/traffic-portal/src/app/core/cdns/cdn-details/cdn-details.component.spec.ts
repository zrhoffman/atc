...
import { CDNDetailsComponent } from "./cdn-details.component";

describe("CDNDetailsComponent", () => {
	let component: CDNDetailsComponent;
	let fixture: ComponentFixture<CDNDetailsComponent>;
	...
	beforeEach(async () => {
		await TestBed.configureTestingModule({
			declarations: [CDNDetailsComponent],
		...
		fixture = TestBed.createComponent(CDNDetailsComponent);
