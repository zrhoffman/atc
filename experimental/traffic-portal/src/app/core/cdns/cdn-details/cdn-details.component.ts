...
/**
 * CDNDetailsComponent is the controller for a CDN's "details" page.
 */
@Component({
	selector: "tp-cdn-details",
	styleUrls: ["./cdn-details.component.scss"],
	templateUrl: "./cdn-details.component.html",
})
export class CDNDetailsComponent implements OnInit {
	public new = false;
